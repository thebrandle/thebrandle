...
/* Framer ships each nav label twice and swaps the copies on hover at runtime.
   ...
   spare still paints here - and with no Framer runtime there is no hover swap
   for it to serve. Hide it outright, only inside the open menu. */
.svc-nav-wrap .bm-open a>.framer-7xhv9u{display:none!important}
