...
const EMIT = [
  'about',
  'contact',
  // '/projects' is deliberately absent: the work listing is generated by
  // gen-service-pages-v2.js so it can cover projects that are not in the Framer
  // CMS collection. Emitting it here too would mean whichever generator ran last
  // silently won.
